...
(function () {
  ...
  var KB = [
    { id: "pricing", k: ["how much", "how much do", "how much does", "price", "pricing", "prices", "cost", "costs", "rate", "rates", "charge", "charges", "fee", "fees", "quote", "estimate", "budget", "afford", "affordable", "expensive", "cheap", "ballpark", "package", "packages", "$"],
      a: "Launch websites start at $899 for up to five pages, mobile design, search basics and a contact form. The quote confirms content, revisions and scope. Booking, payments, AI and paid services cost extra. Grow starts at $2,499; legacy sites at $1,499. Care starts at $39/month.",
    ...
    { id: "existing", k: ["already have a site", "already have a website", "existing site", "existing website", "current site", "current website", "have a website", "have a site", "improve my site", "improve my website", "fix my site", "update my site", "redo my site", "redesign", "tune up", "tune-up", "seo", "search ranking", "google ranking", "rank higher", "ranking", "show up on google", "found on google", "competitor", "competitors", "competition", "competitor analysis"],
      a: "Existing-site improvements start at $299, with the specific work agreed in a fixed quote. Share your URL for a free initial audit; integrations and paid services are scoped separately.",
    ...
    { id: "ai", k: ["ai", "chatbot", "chat bot", "chat assistant", "assistant", "bots", "automation", "automate", "automated", "automating", "artificial intelligence", "machine learning"],
      a: "AI is optional. Explore the text tools and audio transcription example on this site. Matthew scopes the task, integrations, running costs and human review before recommending a setup.",
    ...
    { id: "customers", k: ["more customers", "more business", "more leads", "more sales", "more calls", "more bookings", "grow my business", "get customers", "get more", "will it work", "worth it", "roi", "pay for itself", "increase sales", "increase revenue"],
      a: "A clearer website can make it easier to understand your services and send an inquiry. Results also depend on your offer, traffic and follow-up. We can agree how to track inquiries; I do not promise a particular ranking or number of jobs.",
    ...
    { id: "meta", k: ["are you real", "is this real", "real ai", "are you a bot", "are you human", "are you ai", "chatgpt", "how do you work", "scripted", "is this a real", "are you actually"],
      a: "I’m a demo assistant. Some questions use prepared answers; others are sent to an AI service, with prepared answers as a fallback. Confirm project scope and pricing directly with Matthew.",
    ...
    { id: "realone", k: ["real one", "real version", "what can the real", "trained on", "for my business", "like your best", "what can it do", "what could it do"],
      a: "An assistant can help answer service questions and collect inquiries. Booking, alerts and human handoff depend on supported integrations and are scoped and tested separately.",
    ...
    { id: "work", k: ["work", "portfolio", "examples", "example", "show me", "see your", "projects", "sites you", "samples", "sample", "case study", "case studies", "proof"],
      a: "The work section includes independent Evergreen and Woodrow concepts, clearly labelled as demonstrations, alongside archive, shop and web app builds. Concepts are not client endorsements.",
    ...
    { id: "legacy", k: ["legacy", "memorial", "memorials", "archive", "sermon", "sermons", "life's work", "lifes work", "preserve", "preservation", "family history", "genealogy", "obituary", "tribute", "church", "scholarship"],
      a: "A specialty of mine. I take a lifetime of material — sermons, writing, art, family history — and turn it into a searchable, beautiful site built to outlive the next platform. Legacy sites start at <strong>$1,499</strong>; Pastor Jack Werth's 641 sermons are a good example.",
    ...
    { id: "timeline", k: ["how long", "timeline", "how fast", "when", "turnaround", "quick", "quickly", "deadline", "how soon", "ready by", "take to build"],
      a: "A Launch site usually takes 2–3 weeks once content and access are ready. Larger sites with booking, a shop or AI typically take 4–8 weeks. We confirm availability and milestones before starting.",
      chips: ["How much?", "Start a project"] },
    { id: "hosting", k: ["host", "hosting", "domain", "server", "github", "cheap to run", "monthly cost", "ongoing cost", "monthly fee", "running costs"],
      a: "A simple static website may qualify for free hosting. Domain renewal, form usage, booking, payments and AI services can add recurring costs. Your quote separates setup costs from ongoing costs.",
